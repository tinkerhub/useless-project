  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        kind: "gallery",
        items: [
          { title: "1. fork it", text: "Hit Fork to copy it to your own account.", image: "/handbook/fork-guide.webp" },
          { title: "2. clone it", text: "Hit Code, copy the HTTPS URL, and clone it locally.", image: "/handbook/clone-guide.webp" },
        ],
      },
      {
        kind: "steps",
